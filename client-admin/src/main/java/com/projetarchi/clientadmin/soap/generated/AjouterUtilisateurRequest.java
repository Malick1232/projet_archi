 ...
 *         &lt;element name="utilisateur" type="{http://siteactualites.com/soap/utilisateurs}utilisateurCreation"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ajouterUtilisateurRequest")
public class AjouterUtilisateurRequest {
    ...
    @XmlElement(required = true, namespace = "http://siteactualites.com/soap/utilisateurs")
    protected UtilisateurCreation utilisateur;
     ...
     * @return
     *     possible object is
     *     {@link UtilisateurCreation }
     *     
     */
    public UtilisateurCreation getUtilisateur() {
        return utilisateur;
    }
     ...
     *     
     */
    public void setUtilisateur(UtilisateurCreation value) {
