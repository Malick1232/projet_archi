 ...
 *         &lt;element name="utilisateur" type="{http://siteactualites.com/soap/utilisateurs}utilisateurModification"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "modifierUtilisateurRequest")
public class ModifierUtilisateurRequest {
    ...
    @XmlElement(required = true, namespace = "http://siteactualites.com/soap/utilisateurs")
    protected UtilisateurModification utilisateur;
     ...
     * @return
     *     possible object is
     *     {@link UtilisateurModification }
     *     
     */
    public UtilisateurModification getUtilisateur() {
        return utilisateur;
    }
     ...
     *     
     */
    public void setUtilisateur(UtilisateurModification value) {
